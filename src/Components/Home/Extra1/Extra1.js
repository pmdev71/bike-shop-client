            ...
            <div className="row row-cols-1 row-cols-md-4 g-4 w-75 m-auto">
                ...
                <div className="col col1">
                    <div className="card p-2 h-100">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">SUGGEST HELMATE</h5>
                ...
                <div className="col col1">
                    <div className="card p-2 h-100">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">SAVE OIL</h5>
                ...
                <div className="col col1">
                    <div className="card p-2 h-100">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">DRIVING GUIDE</h5>
                            <p className="card-text">Although manual gearboxes are commonplace, automatic gearboxes are increasingly popular –and the art of driving a stick shift.</p>
                        </div>
                    </div>
                </div>
            </div>
