...
const AddReview = () => {
    ...
    const onSubmit = datas => {
        ...
        console.log(data);
        axios.post('https://afternoon-gorge-53746.herokuapp.com/reviews', data)
            .then(res => {
    ...
    return (
        <div className="bgg">
            ...
            <p className="text-warning">Please Write a Review*</p>
            <div className="row p-2 mb-5">
                <div className="col-md-6 col-12 mx-auto mb-5 bg2">

                    <form className="bg-white px-4" onSubmit={handleSubmit(onSubmit)}>
                        <input disabled className="w-100 bg-dark text-white mt-4 p-2" value={user?.displayName} />
                        <br />
                        <textarea className="w-100 mt-2" placeholder="Write A Review" {...register("desc", { required: true })} />
                        <br />
                        ...
                        <br />
                        <input className="btn btn-dark mb-2 rounded-pill ps-5 pe-5" type="submit" />
                    </form>
                </div>
